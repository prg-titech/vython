...
primitive_classes = {"src/transpiler/lib/vt_prop_lib/primitive_lib/Primitive_Bool.py","src/transpiler/lib/vt_prop_lib/primitive_lib/Primitive_String.py","src/transpiler/lib/vt_prop_lib/primitive_lib/Primitive_Number.py"}

# larkToIRを参考に実装する
class TranspilerToVTProp(Transformer):

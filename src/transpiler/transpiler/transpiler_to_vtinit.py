...
primitive_classes = {"src/transpiler/lib/only_vt_lib/primitive_lib/Primitive_Bool.py","src/transpiler/lib/only_vt_lib/primitive_lib/Primitive_String.py","src/transpiler/lib/only_vt_lib/primitive_lib/Primitive_Number.py"}

# larkToIRを参考に実装する
class TranspilerToVTInit(Transformer):
